...
and its related services, building and management of new website and its content (done by Richard Castro), and proper SEO services. Once AP Asia Tech Co., LTD was warned for non-profit status
requirement as owner of the domain, Milos Preocanin (DL) called his non-profit partner "Zavod Premik" from Slovenia and attached "Zavod Premik"
...
Our intention is to make a clear path to updated, optimized, professional website that will provide bleeding-edge look-n-feel to our visitors, clients and on-boarding businesses. In order to achieve that,
website will follow certain standards and active trends in order to achieve best online presence. As the website will have various initial boosts to gain more traffic, this worker will not support and legally will prosecute
any non-approved marketing that is not aligned with the goals/process of this worker intent. Zavod Premik and worker manager are taking all legal responsibility and obligation towards domain bitshares.org, its sub-domains and content/marketing that is being presented and related to them.
...
- Full Security
- Above "A" grade on both PageSpeed & YahooSlow for home page (landing page)
- Mailchimp newsletter integrated to enable subscriptions to the newsletter
- CDN Integration
- Website Terms and Conditions 

After these are processed, demo.bitshares.org will be permanently moved to bitshares.org. Although, development will have to be approved/merged on the github by the blockchain responsible and authorized devs (which happens every month during review).
## **Legal Disclaimer**
